...
export function Career() {
  ...
  return (
    ...
    >
      ...
      >
        <FileTextIcon className='size-7 animate-pulse stroke-[1.5] text-purple-400' />
        <TypeAnimation
          sequence={['Experience & Education', 5000, '']}
          speed={50}
          repeat={Infinity}
          cursor={true}
          wrapper='h2'
          className='text-4xl font-bold tracking-tight bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent drop-shadow'
        />
      </motion.div>
