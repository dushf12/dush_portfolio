  ...
  return (
    ...
    >
      <motion.form
        ...
        className="glass rounded-2xl shadow-lg p-8 space-y-6 transition-all duration-300 hover:shadow-xl"
      >
        <motion.div
        ...
        <motion.button
          ...
          className={`w-full py-3 rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-2
            ${isSubmitting
              ...
              : 'bg-gradient-to-r from-purple-400 to-pink-400 text-white hover:from-purple-500 hover:to-pink-500 shadow-lg hover:shadow-purple-400/25'
            }`}
        >
          {isSubmitting ? (
            <>
